...
# === Saving ===
# Save Aspect Ratios
np.savetxt("results/pure_stability_aspect_bc.txt", aspect_bc, header="Aspect Ratio BC")
np.savetxt("results/pure_stability_aspect_ic.txt", aspect_ic, header="Aspect Ratio IC")

# Save Inf-Sup Constants
np.savetxt("results/pure_stability_infsup_bc.txt", inf_sup_bc, header="Inf-Sup BC")
np.savetxt("results/pure_stability_infsup_ic.txt", inf_sup_ic, header="Inf-Sup IC")

# Save Rates
np.savetxt("results/pure_stability_rates_bc.txt", rate_hold_bc, header="Decay Rate BC")
np.savetxt("results/pure_stability_rates_ic.txt", rate_hold_ic, header="Decay Rate IC")